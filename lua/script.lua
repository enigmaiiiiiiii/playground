...
MiniHues.make_palette = function(config)
  ...
  local saturation = config.saturation
...
config = { background = "#272a2c", foreground = "#d0d0e4", n_hues = 8, saturation = 'high' }
res = MiniHues.make_palette(config)
